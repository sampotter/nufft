...
** Immediate todo
   ...
   - [ ] Numerical results section
	 ...
	 - [ ] Reference methods that we compare with
   ...
   - [ ] Conclusion
	 ...
	 - [ ] Future work:
	   ...
	   - [ ] Stencil for adaptive FMM/FMRI
	   - [ ] Qi Hu's approach to heterogeneous FMM
	   - [ ] Chebyshev basis instead of monomial basis
		 - [ ] Find reference
	   - [ ] Multiple dimensions
   - [ ] NUFFT section
	 - [ ] Add sinc/Dirichlet kernel formulation of interpolation
       problem
	 - [ ] Incorporate "DFT frequency sets" terminology
